...
public class BMTExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BMTDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BMTStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BMTDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BMTDateTimeConverter dateTimeConverter = new BMTStandardDateTimeConverter();

    public BMTExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BMTExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BMTMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BMTHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BMTExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BMTHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
