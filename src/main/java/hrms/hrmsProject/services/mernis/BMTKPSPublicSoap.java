...
public class BMTKPSPublicSoap
{
    ...
    public BMTKPSPublicSoap(){}

    public BMTKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BMTKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BMTExtendedSoapSerializationEnvelope envelope= new BMTExtendedSoapSerializationEnvelope(BMTExtendedSoapSerializationEnvelope.VER11);
